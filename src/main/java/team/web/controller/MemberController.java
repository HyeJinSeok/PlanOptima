...
import team.web.domain.ScheduleService; // ScheduleService 임포트 추가
...
public class MemberController {
    ...
    public LoginStatusResponse checkLoginStatus(HttpServletRequest request) {
        ...
        if (sessionObject instanceof Member) {
            Member loggedInMember = (Member) sessionObject;
            System.out.println("Logged-in user: " + loggedInMember.getName());  // 디버깅용 로그 추가
